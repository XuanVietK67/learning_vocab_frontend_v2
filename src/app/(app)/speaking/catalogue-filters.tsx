...
/**
 * The catalogue's topic + level filter row. Pure URL state (brief §4.1): a change
 * pushes new search params and the server page re-fetches, so the result set is
 * shareable and back-button friendly. A pending transition keeps the chrome alive
 * (no flash) while the new list streams in.
 */
