...
luyện tập, cộng đồng và thiết lập. Quản trị viên đi vào khu vực quản trị riêng
gồm quản trị từ vựng, chủ đề và người dùng.
...
luyện nói). Hình~\ref{fig:ui-admin-vocab} và Hình~\ref{fig:ui-admin-review} là
...
\figph{ui-practice-speak.png}{0.85}{Màn hình luyện nói / phát âm}{fig:ui-practice-speak}
